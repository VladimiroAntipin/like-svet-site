...
const Contacts = () => {
  return (
    <section className="w-full py-12 max-[500px]:py-6 scroll-mt-30 max-[500px]:scroll-mt-20" id="contacts">
      <div className="container mx-auto text-center px-4">
        <h2 className="text-3xl font-bold mb-10 text-gray-800">Контакты</h2>
